...
void Game::initVariables()
{
	...
	this->asteroidspeed = 10.0f;
}
void Game::initWindow()
{
	this->videomode.height = 600;
	this->videomode.width = 800;
	this->window = new sf::RenderWindow(sf::VideoMode(1400, 800), "Meteor Mash", sf::Style::Titlebar | sf::Style::Close);
...
void Game::inittext()
{
	...
	this->tryagainText.setFillColor(sf::Color::White);
